...
import 'package:flutter_wjob/screens/CV_Create_Screen/Add_Education_Screen.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Widget pour afficher la photo dans un cercle
          _buildProfileImage(),
    ...
    return GestureDetector(
      ...
      child: CircleAvatar(
        ...
        backgroundImage: _profileImage != null
            ...
            : const AssetImage('lib/assets/profiles.png') as ImageProvider, // Image par défaut
        child: _profileImage == null
            ? const Icon(Icons.camera_alt, size: 30, color: Colors.white) // Icône de caméra si aucune image n'est sélectionnée
            : null,
      ),
    );
  }
