...
//   Widget _buildActionButtonsali(BuildContext context) {
//   return Row(
...
//         ElevatedButton.icon(
//           onPressed: () {
//               _chatBotKey.currentState?.generateCoverLetter();
//           },
//         icon: _isLoading 
//             ? const SizedBox(
//                 width: 16,
...
//         label: const Text('Generate AI', style: TextStyle(color: Colors.white)),
//         style: ElevatedButton.styleFrom(
