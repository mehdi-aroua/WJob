...
class _AddSocialMediaScreenState extends State<AddSocialMediaScreen>
  ...
  void _addSocialMedia() {
    ...
    setState(() {
      _socialMediaLinks.add(socialMediaData);
      PdfGenerator.bigList.add(socialMediaData);
    });

    print('BIGLIST after social media: ${PdfGenerator.bigList}');
  ...
  void _goToNextPage() {
    ...
    // Print the final BIGLIST
    print('FINAL BIGLIST: ${PdfGenerator.bigList}');
    
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const AddCoverLetterScreen(),
      ),
    );
  }
