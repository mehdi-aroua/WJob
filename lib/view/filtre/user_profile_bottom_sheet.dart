...
import 'package:flutter_wjob/view/filtre/apply_question.dart';

class UserProfileBottomSheet extends StatefulWidget {
  final UserInfo user;
// final List<JobItem>? jobs;
  List<JobItem> jobList = [];
UserProfileBottomSheet({required this.user , required this.jobList});
  ...
  Widget _buildNextButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ApplyQuestion(jobList: widget.jobList,)),
      );
      },
      child: Container(
        width: 150,
