...
import 'package:flutter_wjob/add_car.dart';
import 'package:flutter_wjob/profile.dart';
...
import 'package:flutter_wjob/withlinkedin.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  WithLinkedIn() ,//LoginScreen()//AddCoverLetterScreen() //const LoginScreen(),
    );
  }
}
